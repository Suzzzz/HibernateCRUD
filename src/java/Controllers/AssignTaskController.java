 ...
 * @author Suharsha
 */
@WebServlet(name = "AssignTaskController", urlPatterns = {"/AssignTaskController"})
public class AssignTaskController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            AssignTask ac=new AssignTask(task_id,  emp_id);;
         TaskServices acs=new TaskServices();
         String resultMessage=acs.assignTasks(ac);
             
 
       
         RequestDispatcher rd =request.getRequestDispatcher("Assign_Tasks.jsp?message2="+resultMessage); 
